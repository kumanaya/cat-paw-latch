...
const EVAL_REFUSED =
  ...
  "value — the refusal names the page; empty that field there if it still resolves, or load " +
  "another page there, to lift it";
...
export const TOOLS: ToolSpec[] = [
  ...
  },
  {
    ...
    description:
      ...
      `without returning them to you (${EVAL_REFUSED}). ` +
  ...
  },
  {
    ...
    description:
      ...
      `anything else, except that ${EVAL_REFUSED}.`,
    inputSchema: {
      type: "object",
      required: ["session"],
      properties: {
  ...
  },
  {
    ...
    description:
      ...
      `you are driving, and ${EVAL_REFUSED}; treat it as you ` +
