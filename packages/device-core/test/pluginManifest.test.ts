...
describe("parseManifest", () => {
  ...
  it.each([
    ...
    ["a binary without a sha for every arch", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64) } }] } }), "binary b needs a sha256 for darwin arm64 and x64"],
    ["a binary with a non-https url", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "http://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) } }] } }), "binary b needs an https url for darwin arm64 and x64"],
    ...
    ["a platform block for an OS the schema does not know", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) }, platforms: { plan9: { url: { arm64: "https://x/9", x64: "https://x/9" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) } } } }] } }), "binary b platforms must be darwin, win32 or linux"],
    ["a darwin block redeclaring the top-level pins", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) }, platforms: { darwin: { url: { arm64: "https://x/d", x64: "https://x/d" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) } } } }] } }), "binary b must not redeclare darwin; the top-level url and sha256 are darwin's"],
    ["a platform block missing a sha", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) }, platforms: { win32: { url: { arm64: "https://x/w", x64: "https://x/w" }, sha256: { arm64: "a".repeat(64) } } } }] } }), "binary b needs a sha256 for win32 arm64 and x64"],
    ["a platform block with a non-https url", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) }, platforms: { linux: { url: { arm64: "http://x/l", x64: "https://x/l" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) } } } }] } }), "binary b needs an https url for linux arm64 and x64"],
    ["a platform executable that escapes the plugin", withPatch({ runtime: { binaries: [{ name: "b", url: { arm64: "https://x/b", x64: "https://x/b" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) }, platforms: { win32: { executable: "/b.exe", url: { arm64: "https://x/w", x64: "https://x/w" }, sha256: { arm64: "a".repeat(64), x64: "a".repeat(64) } } } }] } }), "binary b executable must be a path inside the plugin"],
